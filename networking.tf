...
resource "aws_instance" "logs" {
  ...
  iam_instance_profile        = aws_iam_instance_profile.data_ec2_profile.name
...
resource "aws_iam_role" "data_ec2_role" {
  name = "data_ec2_role"
...
resource "aws_iam_instance_profile" "data_ec2_profile" {
  name = "data_ec2_profile"
  role = aws_iam_role.data_ec2_role.name
}

resource "aws_iam_role_policy" "ec2_delivery_policy" {
  role = aws_iam_role.data_ec2_role.id
